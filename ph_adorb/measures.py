...
class CO2MeasureCollection(BaseModel):
    """A collection of CO2 Reduction Measures."""

    _measures: dict[str, CO2ReductionMeasure] = PrivateAttr(default_factory=dict)

    def add_measure(self, factor: CO2ReductionMeasure) -> None:
        self._measures[factor.name] = factor

    def get_measure(self, key: str) -> CO2ReductionMeasure:
    ...
    def __contains__(self, key: str | CO2ReductionMeasure) -> bool:
    ...
    @property
    def performance_measures(self) -> "CO2MeasureCollection":
        """Return a collection of PERFORMANCE measures."""
        new_collection = CO2MeasureCollection()
    ...
    @property
    def nonperformance_measures(self) -> "CO2MeasureCollection":
